/*import 'package:app_web_proyecto_final/inner_screens/Todos_Mangas_Categoria.dart';
import 'package:flutter/material.dart';
import 'package:app_web_proyecto_final/inner_screens/LoginScreen.dart';
import 'package:app_web_proyecto_final/inner_screens/todos_mangas.dart';
...
class _SideMenuState extends State<SideMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    final themeState = Provider.of<DarkThemeProvider>(context);
    final theme = Utils(context).getTheme;
    MyAppAuthProvider.AuthProvider authProvider = Provider.of<
            MyAppAuthProvider.AuthProvider>(
        context); //Agregué este prefijo del AuthProvider para evitar ambiguedad
